...
export const MarketsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="glass-panel rounded-3xl p-4 border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">

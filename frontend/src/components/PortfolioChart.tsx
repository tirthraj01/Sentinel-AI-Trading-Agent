...
export const PortfolioChart: React.FC<PortfolioChartProps> = ({ portfolio }) => {
  ...
  return (
    <div className="terminal-panel rounded-[28px] p-5 sm:p-6 relative overflow-hidden">
      <div className="terminal-glow" />
      <div className="relative">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <span className="text-[10px] font-bold uppercase tracking-[0.28em] text-cyan-300/80 block mb-2">
            ...
            <div className="flex items-baseline gap-3">
              ...
              <span className="text-xs font-bold font-tabular text-emerald-300 bg-emerald-500/10 border border-emerald-500/25 px-2.5 py-0.5 rounded-full">
          ...
          <div className="flex flex-wrap items-center gap-2 self-start sm:self-auto">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-2xl border transition-all ${
                showBenchmark
                  ? "bg-cyan-500/20 text-cyan-300 border-cyan-500/40 shadow-[0_0_18px_rgba(34,211,238,0.18)]"
                  : "bg-[#101923] text-slate-300 border-cyan-500/10 hover:text-white"
              }`}
            >
            ...
            <div className="flex items-center gap-1 bg-[#101923] p-1 rounded-2xl border border-cyan-500/10">
              {timeframes.map((tf) => (
                <button
                  key={tf}
        ...
        <div className="h-64 sm:h-72 w-full rounded-[22px] border border-cyan-500/10 bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.08),_transparent_35%)] p-2">
